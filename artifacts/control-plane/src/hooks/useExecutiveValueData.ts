...
export function useExecutiveValueData() {
  ...
  return useMemo(() => ({ summary, domains, topDrivers, blockers, loading, error, refresh, generateEvidencePack }), [summary, domains, topDrivers, blockers, loading, error, refresh, generateEvidencePack])
}
