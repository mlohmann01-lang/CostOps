  ...
  return {
    ...
    tenantReadiness: {
      ...
      items: [
        ...
        ["executiveProofPacks", "Executive Proof Packs"],
        ["governedExecution", "Governed execution readiness"],
      ].map(([key, label]) => ({
        key,
        label,
  ...
  return {
    ...
    tenantReadiness: {
      ...
      items: [
        ...
        {
          key: "executiveProofPacks",
          label: "Executive Proof Packs",
          status: "MISSING",
          reason: "Executive proof packs unavailable.",
          nextStep: "Build executive proof packs from verified portfolio and evidence.",
        },
        {
          key: "governedExecution",
          label: "Governed execution readiness",
          status: "MISSING",
          reason: "Governed actions unavailable.",
