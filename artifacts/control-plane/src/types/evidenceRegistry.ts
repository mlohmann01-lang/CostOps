...
export type EvidenceRegistryDataState='LIVE'|'DEMO'|'NOT_CONNECTED'|'NO_DATA';
export interface EvidenceRegistryState{mode:'DEMO'|'LIVE';snapshot:EvidenceRegistrySnapshot|null;records:EvidenceRecord[];selectedChain?:EvidenceChain|null;unavailable:boolean;demoLabel?:string;dataState:EvidenceRegistryDataState;error?:string}
