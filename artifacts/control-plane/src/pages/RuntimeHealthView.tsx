...
export default function RuntimeHealthView() {
  ...
  return <Shell><div style={{ padding: 20, display: 'grid', gap: 16 }}>
    ...
    <section data-testid='m365-onboarding-runtime' style={{ border: 'var(--border-default)', background: 'var(--bg-card)', borderRadius: 10, padding: 12 }}><SectionLabel>M365 Onboarding</SectionLabel><div>NOT_STARTED / IN_PROGRESS / BLOCKED / READY_FOR_PILOT</div><div>Complete Microsoft 365 onboarding before controlled validation.</div></section>
