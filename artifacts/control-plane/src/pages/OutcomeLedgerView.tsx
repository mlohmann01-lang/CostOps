...
export default function OutcomeLedgerView(){const {data,isEmptyLive}=useOutcomesData(); if(isEmptyLive) return <Shell><EmptyState title='No verified savings yet' description='Outcomes will appear here as actions are executed and savings are evidence-verified.' /></Shell>
