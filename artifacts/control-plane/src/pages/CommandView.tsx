...
export default function CommandView({ params }: { params?: { domain?: string } }) {
  ...
  const m365Opportunities = (opportunities.data.opportunities ?? topOpportunities).filter((opp:any) => opp.source === 'M365_PLAYBOOK' || opp.domain === 'M365').slice(0, 4)
