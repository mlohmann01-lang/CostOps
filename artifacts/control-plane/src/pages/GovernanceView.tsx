...
export default function GovernanceView() {
  ...
  const graphResult = useGovernanceGraphData()
  const aiResult = useAIGovernanceExposureData()
  const auditResult = useEvidenceAuditData()
  const graph = graphResult.data
  const ai = aiResult.data
  const audit = auditResult.data
  const combinedState = worstDataState(governance.dataState, graphResult.dataState, aiResult.dataState, auditResult.dataState)
