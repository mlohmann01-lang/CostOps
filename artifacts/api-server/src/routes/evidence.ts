...
const router = Router(); const service = new EvidenceRegistryV2Service(); const tenant = (req: any) => req.__authContext?.tenantId ?? req.headers["x-tenant-id"] ?? req.query.tenantId ?? "default";
