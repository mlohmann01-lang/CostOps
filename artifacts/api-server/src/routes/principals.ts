...
const router = Router(); const service = new PrincipalAuthorityService(); const assets = new AssetRegistryService(); const tenant = (req: any) => req.__authContext?.tenantId ?? req.headers["x-tenant-id"] ?? req.query.tenantId ?? "default";
