...
export type GovernanceEventType = "RECOMMENDATION_CREATED"|"RECOMMENDATION_RECALCULATED"|"RECOMMENDATION_APPROVED"|"RECOMMENDATION_BLOCKED"|"RECOMMENDATION_SUBMITTED_FOR_APPROVAL"|"APPROVAL_WORKFLOW_CREATED"|"APPROVAL_STAGE_ENTERED"|"APPROVAL_REJECTED"|"READINESS_CHANGED"|"POLICY_BLOCKED"|"EXECUTION_REQUEST_CREATED"|"DRY_RUN_STARTED"|"DRY_RUN_COMPLETED"|"DRY_RUN_BLOCKED"|"OUTCOME_VERIFICATION_STARTED"|"OUTCOME_VERIFIED"|"OUTCOME_PARTIALLY_VERIFIED"|"OUTCOME_VERIFICATION_FAILED"|"EXECUTION_STARTED"|"EXECUTION_BLOCKED"|"EXECUTION_COMPLETED"|"EXECUTION_FAILED"|"EXECUTION_ROLLBACK_TRIGGERED";
