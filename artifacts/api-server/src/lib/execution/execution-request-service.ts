...
export class ExecutionRequestService {
  ...
  async list(tenantId: string) { return this.requestRepo.list(tenantId); }
  async get(tenantId: string, executionRequestId: string) { return this.requestRepo.getByExecutionRequestId(tenantId, executionRequestId); }
