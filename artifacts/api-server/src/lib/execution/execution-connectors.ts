...
export const executionConnectorCapabilityRegistry: Record<ExecutionConnectorType, ConnectorCapability[]> = {
  ...
  ITAM: ["READ_ASSET", "READ_LICENSE", "READ_CONTRACT", "READ_OWNER", "ASSIGN_OWNER", "ASSIGN_COST_CENTRE", "RECLAIM_LICENSE", "RESTORE_LICENSE_ITAM", "MARK_RETIRED", "MARK_ACTIVE", "CREATE_RENEWAL_REVIEW", "CONSOLIDATE_CAPABILITY", "VERIFY_ASSET_STATE", "ROLLBACK_ITAM_ACTION"],
  FLEXERA: ["READ_ASSET", "READ_LICENSE", "READ_CONTRACT", "READ_OWNER", "ASSIGN_OWNER", "ASSIGN_COST_CENTRE", "RECLAIM_LICENSE", "RESTORE_LICENSE_ITAM", "MARK_RETIRED", "MARK_ACTIVE", "CREATE_RENEWAL_REVIEW", "CONSOLIDATE_CAPABILITY", "VERIFY_ASSET_STATE", "ROLLBACK_ITAM_ACTION"],
  OTHER: [],
};
