...
// Subsystem read/decision routes must not import execution engines.
test("subsystem routes must not import execution engines", () => {
  for (const route of ["../routes/recommendations.ts","../routes/simulations.ts","../routes/workflow.ts"]) {
