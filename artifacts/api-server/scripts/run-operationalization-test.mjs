...
const tests = ['src/tests/operationalization.test.ts', 'src/tests/operationalization-packs.test.ts', 'src/tests/enterprise-subsystems.test.ts', 'src/tests/auth-rbac.test.ts', 'src/tests/tenant-isolation.test.ts', 'src/tests/env-validation.test.ts', 'src/tests/security-controls.test.ts', 'src/tests/auth-providers.test.ts', 'src/tests/tenant-isolation-v2.test.ts', 'src/tests/deployment-runtime.test.ts', 'src/tests/observability-metrics.test.ts', 'src/tests/security-anomaly.test.ts', 'src/tests/tenant-isolation-v3.test.ts', 'src/tests/auth-session-v3.test.ts', 'src/tests/enterprise-graph.test.ts', 'src/tests/workflow-intelligence.test.ts', 'src/tests/runtime-controls-v4.test.ts', 'src/tests/runtime-controls-enforcement.test.ts', 'src/tests/execution-orchestration-operational-controls.test.ts', 'src/tests/execution-orchestration-operator-actions.test.ts', 'src/tests/execution-orchestration-processor.test.ts'];
